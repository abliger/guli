...
public class CodeGeneratorTest {
    @Test
    void codeGen() {
        String prefix = "guli";//用来拼接连接数据库的url地址数据库名称的、根据实际修改
        ...
        dsc.setUrl("jdbc:mysql://rm-uf6f305on2m87y30mlo.mysql.rds.aliyuncs.com:3306/" + prefix + "_" + moduleName + "?serverTimezone=GMT%2B8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("abliger");
        dsc.setPassword("w2KAi3pRmTdnx3qp");
